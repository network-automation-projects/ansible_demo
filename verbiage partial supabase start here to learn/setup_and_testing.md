...
- **Ingest** — Paste or enter report text; optionally set doc ID, title, source, and chunk size/overlap. Submit to run ingest. Success or error message appears below the form.
