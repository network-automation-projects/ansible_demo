...
Work through `exercises.py` for fill-in-the-blank practice (beginner: model definition and parse; intermediate: validators; advanced: BaseSettings or API-style model).
