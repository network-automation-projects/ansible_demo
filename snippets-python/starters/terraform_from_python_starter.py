"""
Run Terraform from Python.
Copy run_terraform and parse_plan_summary into your automation or CI.
"""
...
def main() -> None:
    ...
    tf_dir = base / "terraform_starter"
    if not tf_dir.exists():
        print("terraform_starter/ not found at", tf_dir)
        return

    print("Running terraform init...")
    init_result = run_terraform(tf_dir, "init")
    ...
    plan_result = run_terraform(tf_dir, "plan", "-input=false")
