...
class DeviceStrict(BaseModel):
    ...
    def normalize_hostname(cls, v: Any) -> str:
        if isinstance(v, str):
            ...
            return v
        return ValueError("hostname cannot be empty")
...
class ValidationReport(BaseModel):
    ...
    #input looks like: total=1, passed=1, failed=0, devices=[]
